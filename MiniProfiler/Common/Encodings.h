...
namespace CppEssentials
{
    ...
    public:
        ...
        ///
        virtual void WriteWideChars(const wchar_t * sourceBuffer, UInt32 sourceBufferCharCount, IOutputStream * writer) = 0;
    ...
    public:
        ...
        virtual byte GetMaxBytesPerCharacter();

        virtual IEncoder * Clone() const;

        virtual UInt32 ReadWideChars(wchar_t * targetBuffer, UInt32 targetBufferByteCount, IInputStream * reader);

        virtual void WriteWideChars(const wchar_t * sourceBuffer, UInt32 sourceBufferCharCount, IOutputStream * writer);

        virtual void ReadByteOrderMark(IInputStream * reader);

        virtual void WriteByteOrderMark(IOutputStream * writer);
    };
