...
namespace CppEssentials
{
	...
	UInt32 UTF16LittleEndianEncoder::ReadWideChars(wchar_t* targetBuffer, UInt32 targetBufferCharCount,
	                                               IInputStream* reader)
	{
	...
	void UTF16LittleEndianEncoder::WriteWideChars(const wchar_t* sourceBuffer, UInt32 sourceBufferCharCount,
